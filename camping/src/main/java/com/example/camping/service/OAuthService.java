...
public class OAuthService {
    ...
    public Member saveUserAndGetToken(String token) {
        ...
        Member member =  memberRepository.findByusername(profile.getKakao_account().getEmail());
        if(member == null) {
        	member= Member.builder()
                    .username(profile.getId())
                    					.password(profile.getKakao_account().getProfile().getNickname())
        ...
        Authentication saveUserAndGetToken = new  UsernamePasswordAuthenticationToken(profile, member);
